 ...
 * with actual data provided through an {@link AuditContext} instance.
 * <p>
 ...
 * in the {@code AuditContext} object.
 * </p>
 *
 * @see AuditContext
 * @since 1.0
...
public interface AuditLogTemplateResolver {
     ...
     * from the given {@link AuditContext} object.
     * <p>
     ...
     * @param context  the resolved audit context that provides the dynamic values for the template
     * @return a fully resolved string with all applicable placeholders replaced by actual values
     */
    String resolveTemplate(String name, String template, AuditContext context);
}
