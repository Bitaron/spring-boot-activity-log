...
public class AuditLogClientData {
     ...
     * @param expressionActorValue the value {@code actorExpression} evaluated to, already resolved
     *                           by the caller (the aspect owns the SpEL/reflection machinery, not
     *                           this class); only consulted when {@code audit.actorSource() ==
     *                           ActorSource.EXPRESSION}, ignored otherwise
     */
    public AuditLogClientData(Audit audit, Object args, Object response, boolean exceptionThrown,
        ...
        switch (audit.actorSource()) {
            ...
            case EXPRESSION -> {
                this.actorId = expressionActorValue;
                this.actorName = expressionActorValue;
            ...
            case CONTEXT -> resolveCommonActor(auditLogGenericDataGetter, auditLogProperties, auditLogLocationResolver);
        }
        this.args = args;
